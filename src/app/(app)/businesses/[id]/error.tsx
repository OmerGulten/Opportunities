...
/** Error boundary for a single business profile. */
export default function BusinessDetailError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  const t = useT("errors");
    ...
    <div className="flex min-h-[40vh] flex-1 items-center justify-center">
      <div className="flex max-w-md flex-col items-center gap-4 text-center">
        ...
        <div className="space-y-1">
          <h1 className="font-heading text-lg font-semibold">{tb("detail.notFoundTitle")}</h1>
